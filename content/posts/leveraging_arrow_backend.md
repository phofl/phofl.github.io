...
PyArrow dtypes were initially introduced in pandas 1.5. This means that support for them is
...
for a couple of months. Both projects work continuously to improve support throughout Dask and 
pandas.
